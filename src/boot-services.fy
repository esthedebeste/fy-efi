...
struct EFI_BOOT_SERVICES {
	...
	CreateEvent: *fun cc(EFIAPI) (Type: UINT32, NotifyTpl: EFI_TPL, NotifyFunction: EFI_EVENT_NOTIFY, NotifyContext: EFI_PTR_VOID, Event: *EFI_EVENT): EFI_STATUS, // EFI 1.0+
	SetTimer: EFI_SET_TIMER, // EFI 1.0+
	WaitForEvent: *fun cc(EFIAPI) (NumberOfEvents: UINTN, Event: *EFI_EVENT, Index: *UINTN): EFI_STATUS, // EFI 1.0+
	SignalEvent: *fun cc(EFIAPI) (Event: EFI_EVENT): EFI_STATUS, // EFI 1.0+
	CloseEvent: *fun cc(EFIAPI) (Event: EFI_EVENT): EFI_STATUS, // EFI 1.0+
	CheckEvent: *fun cc(EFIAPI) (Event: EFI_EVENT): EFI_STATUS, // EFI 1.0+
	...
	InstallConfigurationTable: *fun cc(EFIAPI) (Guid: *EFI_GUID, Table: EFI_PTR_VOID): EFI_STATUS, // EFI 1.0+
	// Image Services
	...
	GetNextMonotonicCount: *fun cc(EFIAPI) (Count: *UINT64): EFI_STATUS, // EFI 1.0+
	Stall: *fun cc(EFIAPI) (Microseconds: UINTN): EFI_STATUS, // EFI 1.0+
	SetWatchdogTimer: *fun cc(EFIAPI) (Timeout: UINTN, WatchdogCode: UINT64, DataSize: UINTN, WatchdogData: *CHAR16): EFI_STATUS, // EFI 1.0+
	...
	// 32-bit CRC Services
	CalculateCrc32: *fun cc(EFIAPI) (Data: EFI_PTR_VOID, DataSize: UINTN, Crc32: *UINT32): EFI_STATUS, // EFI 1.1+
	// Miscellaneous Services
	CopyMem: *fun cc(EFIAPI) (Destination: EFI_PTR_VOID, Source: EFI_PTR_VOID, Length: UINTN): EFI_STATUS, // EFI 1.1+
	SetMem: *fun cc(EFIAPI) (Buffer: EFI_PTR_VOID, Size: UINTN, Value: UINT8): EFI_STATUS, // EFI 1.1+
	CreateEventEx: *fun cc(EFIAPI) (Type: UINT32, NotifyTpl: EFI_TPL, NotifyFunction: EFI_EVENT_NOTIFY, NotifyContext: EFI_PTR_VOID, EventGroup: *EFI_GUID, Event: *EFI_EVENT): EFI_STATUS, // UEFI 2.0+
}
